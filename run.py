...
def show_alldata_month7(month):
    ...
    if month == "7":
        ...
        jul_ts = int(alldata_m1_3) + int(alldata_m1_4) + int(alldata_m1_5) + int(alldata_m1_6) + int(alldata_m1_7) + int(alldata_m1_8) + int(alldata_m1_9)
...
def show_alldata_month8(month):
    ...
    if month == "8":
        ...
        aug_ts = int(alldata_m1_3) + int(alldata_m1_4) + int(alldata_m1_5) + int(alldata_m1_6) + int(alldata_m1_7) + int(alldata_m1_8) + int(alldata_m1_9) + int(alldata_m1_10)
...
def show_alldata_month9(month):
    ...
    if month == "9":
        ...
        sep_ts = int(alldata_m1_3) + int(alldata_m1_4) + int(alldata_m1_5) + int(alldata_m1_6) + int(alldata_m1_7) + int(alldata_m1_8) + int(alldata_m1_9) + int(alldata_m1_10) + int(alldata_m1_11)
...
def show_alldata_month10(month):
    ...
    if month == "10":
        ...
        oct_ts = int(alldata_m1_3) + int(alldata_m1_4) + int(alldata_m1_5) + int(alldata_m1_6) + int(alldata_m1_7) + int(alldata_m1_8) + int(alldata_m1_9) + int(alldata_m1_10) + int(alldata_m1_11) + int(alldata_m1_12)
...
def show_alldata_month11(month):
    ...
    if month == "11":
        ...
        nov_ts = int(alldata_m1_3) + int(alldata_m1_4) + int(alldata_m1_5) + int(alldata_m1_6) + int(alldata_m1_7) + int(alldata_m1_8) + int(alldata_m1_9) + int(alldata_m1_10) + int(alldata_m1_11) + int(alldata_m1_12) + int(alldata_m1_13)
...
def show_alldata_month12(month):
    ...
    """
    Projects the chosen month. The data will show the expenses and savings for December.
    The end calaculations shows the total savings from Janauary until December.
    """
    ...
    if month == "12":
        ...
        dec_ts = int(alldata_m1_3) + int(alldata_m1_4) + int(alldata_m1_5) + int(alldata_m1_6) + int(alldata_m1_7) + int(alldata_m1_8) + int(alldata_m1_9) + int(alldata_m1_10) + int(alldata_m1_11) + int(alldata_m1_12) + int(alldata_m1_13) + int(alldata_m1_14)
